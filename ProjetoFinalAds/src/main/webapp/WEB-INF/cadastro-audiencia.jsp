    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span6 offset3">
                    <label  class="breadcrumb text-left">
                        <span style="font-weight: bolder"> ${processo.tipoAcao} - 
                            ${processo.assuntoPrincipal}<br></span>
                        <span style="font-weight: bolder">  Processo:</span> ${processo.numProcesso}<br>
                        <span style="font-weight: bolder">    Cliente: </span> 
                        <c:catch>
                        ...
                        <span style="font-weight: bolder">Advogados:</span> 
                        ...
                        <div class="media">
                            <div class="media-body">
                                <%-- <label class="breadcrumb text-center">
                                    ...
                                    <select name="idProcesso" id="processo"></select>
                                </label> --%>
                                <input name="idProcesso" value="${processo.idProcesso}" type="hidden">
                                <label class="breadcrumb text-center">
                                ...
                                <input type="hidden" value="cadastraAudiencia" name="op">
