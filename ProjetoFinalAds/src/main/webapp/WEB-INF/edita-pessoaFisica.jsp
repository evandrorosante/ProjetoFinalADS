...
<html>
    ...
    <body onload="editaEstado('${pessoaFisica.estado}')">
        <!--HEADER ROW-->
        <div id="header-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                <input type="hidden" value="atualizarClientePF" name="op">
                                <h4 class="text-center">Dados Pessoais </h4>
                                <label class="breadcrumb text-center">
                                    <input readonly value="${pessoaFisica.cpf}" type="text" name="cpf" placeholder="CPF"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="rg" placeholder="RG" value="${pessoaFisica.rg}"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="nome" placeholder="Nome completo" value="${pessoaFisica.nome}"/>
                                </label>
                                <label class="breadcrumb text-center"> 
                                    Data de Nascimento<br>
                                    <input required type="date" name="datanasc" placeholder="Data de nascimento"  value="${pessoaFisica.dataNasc}"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="nacionalidade" placeholder="Nacionalidade" value="${pessoaFisica.nacionalidade}"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <select required name="estadoCivil">
                                        <option value="${pessoaFisica.estadoCivil}">${pessoaFisica.estadoCivil}</option>
                                        <c:if test="${!pessoaFisica.estadoCivil.equals('Solteiro')}">
                                            <option value="Solteiro">Solteiro</option>
                                        </c:if>
                                        <c:if test="${!pessoaFisica.estadoCivil.equals('Casado')}">
                                            <option value="Casado">Casado</option>
                                        </c:if>
                                        <c:if test="${!pessoaFisica.estadoCivil.equals('Divorciado')}">
                                            <option value="Divorciado">Divorciado</option>
                                        </c:if>
                                        <c:if test="${!pessoaFisica.estadoCivil.equals('Separado Judicialmente')}">
                                            <option value="Separado Judicialmente">Separado Judicialmente</option>
                                        </c:if>    
                                    </select>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="profissao" placeholder="Profissao" value="${pessoaFisica.profissao}"/>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <label class="breadcrumb text-center">
                                    <input required type="number" name="cep" id="cep" onblur="buscaEndereco()" placeholder="CEP" value="${pessoaFisica.cep}"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="logradouro" placeholder="Logradouro" value="${pessoaFisica.logradouro}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="number" name="nro" placeholder="Número" value="${pessoaFisica.nro}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input type="text" name="bairro" placeholder="Bairro" value="${pessoaFisica.bairro}"/>
                                </label>
                                <label class="breadcrumb text-center" >
                                    <select required id="estado" name="estado"> </select>
                                </label>
                                <label class="breadcrumb text-center">
                                    <select  required id="cidade" name="cidade"><option>${pessoaFisica.cidade}</option> </select>
                                </label>
                    ...
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="telefone" data-mask="(99)9999-9999" placeholder="Telefone" value="${pessoaFisica.telefone}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="celular" data-mask="(99)99999-9999" placeholder="Celular" value="${pessoaFisica.celular}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input readonly placeholder="E-Mail" type="email" name="email" value="${pessoaFisica.email}" />
                                    <br>
                                </label> 
                                <label class="text-center">
                                    ...
                                    <button type="button" type="button" class="btn-info" Onclick="window.history.go(-1)">
