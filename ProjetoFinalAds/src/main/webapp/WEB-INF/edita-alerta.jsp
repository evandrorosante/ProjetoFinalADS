...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="span12">
                    <div class="page-header">
                        <h3>
                            Gerenciar Alertas de Audiências
                        </h3>
            ...
            <!-- /. PAGE TITLE-->
            <div class="row">
                <form method="post" action="ControleAlerta">
                    <div class="span6 offset3">
                        <div class="media">
                            <div class="media-body">
                                <label class="breadcrumb text-center">
                                    Horário do Alerta:<br>
                                    <input type="time" name="horario" required value="${ca.horario}">
                                </label>
                                <label class="breadcrumb text-center">
                                    Quantidade de dias para ser disparado antes das audiências:<br>
                                    <input type="number" name="dias" required value="${ca.dias}"> 
                                </label>
                                <input type="hidden" value="editaAlerta" name="op">
