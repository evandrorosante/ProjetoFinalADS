            ...
            <div class="row">
                <div class="span12">
                    <div class="page-header">
                        <h3>Consulta de Usuários do Sistema</h3>
                        ...
                        <div class="media-body">
                            <c:if test="${listaUsuarios != null}">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${listaUsuarios}" var="l">
                                        <c:if test="${l.tipo != 1}">
                                            <tr>
                                                <c:if test="${l.ativo == true}">
                                                    <td style="border-bottom: 0px;width: 130px ">
                                                        <form style="margin: 0px" action="ControleUsuario" method="get">
                                                            <button class="btn-success btn-mini"><i class="icon-edit"></i>Alterar
                                                            </button>
                                                            <select class="input-mini" style="margin: 0px" name="ativo" >
                                                                <option selected value="1">Sim</option>
                                                                <option value="0">Não</option>
                                                            </select>
                                                            <input type="hidden" value="editaUsuario" name="op">
                                                            <input type="hidden" name="idPessoa" value="${l.getPessoa().getIdPessoa()}">
                                                        </form>
                                                    </td> 
                                                </c:if>
                                                <c:if test="${l.ativo == false}">
