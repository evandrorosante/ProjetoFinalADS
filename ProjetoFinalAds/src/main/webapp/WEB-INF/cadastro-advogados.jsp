                    ...
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                <h4 class="text-center">Dados do Advogado</h4>
                                <input type="hidden" value="cadastrarAdvogado" name="op">
                                <label class="breadcrumb text-center">
                                    <input class="input-mini" id="nrooab" onblur="validarOAB()" data-mask="999999" required type="text" name="oab" placeholder="OAB"/>
                                    <select required class="input-mini" name="ufOab"> <option value="">UF</option>
                                    ...
                                    <div id="divMsgOAB"></div>
                                </label>                                
                                <label class="breadcrumb text-center">
                                    <input required onblur="validarCPF()" type="text" name="cpf" data-mask="999.999.999-99" placeholder="CPF"/>
                                    <div id="divMsgCPF" style="font-size: 10pt"></div>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="rg" placeholder="RG"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="nome" placeholder="Nome completo"/>
                                </label>
                                <label class="breadcrumb text-center"> Data de Nascimento<br>
                                    <input required type="date" name="datanasc" placeholder="Data de nascimento"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="nacionalidade" placeholder="Nacionalidade"/>
                                </label>
                                <label class="breadcrumb text-center">
                    ...
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <label class="breadcrumb text-center">
                                    <input required onblur="buscaEndereco()" id="cep" type="text" name="cep" placeholder="CEP"/>
                                </label>
                                <label class="breadcrumb text-center">
