...
<html>
    ...
    <body>
        ...
        <div class="container">
            <!--Carousel
            ==================================================-->
            <div style="margin-bottom: 5px" id="myCarousel" class="carousel slide">
                            ...
                            <div class="row">
                                <div class="span6">
                                    <div class="carousel-caption">
                                        <h2>Sistema de Gestão Jurídica</h2>
                                        <%-- Recebe a mensagem de sucesso do cadastro --%>
                                        ${cadastro}
                                        <%-- Recebe a mensagem de sucesso do troca de senha --%>
                                        ${mensagem}
                                        <p style="text-align: justify" class="lead">Bem vindo!<br>
                                            Todas as atividades relacionadas aos processos e ao dia-a-dia do advogado
                                            são gerenciadas no Sistema de Gestão Jurídica de maneira totalmente integrada
                                            e eficaz, propiciando um maior dinamismo e agilidade às atividades cotidianas.</p>
                                            <%--   <a class="btn btn-large btn-primary" href="#">Sign up today</a> --%>
                                    </div>
                                </div>
                                <div class="span3 offset1"> <img src="img/estatua-justica.png"></div>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                                ...
                                <div class="span6">
                                    <div class="carousel-caption">
                                        ...
                                        <p style="text-align: justify" class="lead">
                                            Gerenciamento de clientes, advogados, processos e audiências, além do 
                                            serviço de alerta de audiências enviados para o e-mail dos advogados e dos
                                            clientes.<br>
                                            O Sistema de Gestão Jurídica oferece ainda um serviço de leitura de intimações 
                                            nos diários oficiais.</p>
                                    </div>
                                </div>
                                <div style="margin-top: 100px" class="span3 offset1"> <img src="img/justicabalanca.png"></div>
                            </div>
                        </div>
                    </div>
                </div>
