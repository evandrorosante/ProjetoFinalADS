                        ...
                        <div class="media">
                            <div class="media-body">
                                <label class="breadcrumb text-center">
                                    ...
                                    <select name="idAudiencia" id="processo"></select>
                                </label>
                                Ata de Audiência
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="input-append">
                                        <div class="uneditable-input span3"><i class="icon-file fileupload-exists"></i> <span class="fileupload-preview"></span></div><span class="btn btn-file"><span class="fileupload-new">Selecione o Arquivo</span><span class="fileupload-exists">Alterar</span><input name="ata" type="file" /></span><a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remover</a>
                                    </div>
                                </div>
                                <input type="hidden" value="inserirAtaAudiencia" name="op">
