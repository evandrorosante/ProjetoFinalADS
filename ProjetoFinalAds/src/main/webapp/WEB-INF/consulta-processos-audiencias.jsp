                        ...
                        <div class="media-body">
                            <c:if test="${listaProcessos != null}">
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${listaProcessos}" var="l">
                                        <tr>
                                            <td><a class="btn-success btn-mini" href="ControleAudiencia?op=cadastrarAudiencia&idProcesso=${l.idProcesso}">
                            ...
                            <c:if test="${processo != null}">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td><a class="btn-success btn-mini" href="ControleAudiencia?op=cadastrarAudiencia&idProcesso=${processo.idProcesso}">
                                                    <i class="icon-edit"></i></a>
                                            </td>
                                        <td>
                                            <%--Verifica se o cliente ´pessoa fisíca ou jurídica para exibir o nome --%>
