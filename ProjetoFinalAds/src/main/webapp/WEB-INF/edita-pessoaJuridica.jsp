...
<html>
    ...
    <body onload="editaEstado('${pessoaJuridica.estado}')">
        <!--HEADER ROW-->
        <div id="header-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                <input type="hidden" value="atualizarClientePJ" name="op">
                                <h4 class="text-center">Dados da Empresa </h4>
                                <label class="breadcrumb text-center">
                                    <input readonly value="${pessoaJuridica.cnpj}" type="text" name="cnpj" placeholder="CNPJ"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="inscricaoEstadual" placeholder="Inscrição Estdual" value="${pessoaJuridica.inscricaoEstadual}"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="razaoSocial" placeholder="Razão Social" value="${pessoaJuridica.razaoSocial}"/>
                                </label>
                                <label class="breadcrumb text-center"> 
                                    <input required type="type" name="nomeFantasia" placeholder="Nome Fantasia"  value="${pessoaJuridica.nomeFantasia}"/>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <label class="breadcrumb text-center">
                                    <input required type="number" name="cep" id="cep" onblur="buscaEndereco()" placeholder="CEP" value="${pessoaJuridica.cep}"/>
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="logradouro" placeholder="Logradouro" value="${pessoaJuridica.logradouro}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="number" name="nro" placeholder="Número" value="${pessoaJuridica.nro}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input type="text" name="bairro" placeholder="Bairro" value="${pessoaJuridica.bairro}"/>
                                </label>
                                <label class="breadcrumb text-center" >
                                    <select required id="estado" name="estado"> </select>
                                </label>
                                <label class="breadcrumb text-center">
                                    <select  required id="cidade" name="cidade"><option>${pessoaJuridica.cidade}</option> </select>
                                </label>
                    ...
                    <div class="span4">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="telefone" data-mask="(99)9999-9999" placeholder="Telefone" value="${pessoaJuridica.telefone}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input required type="text" name="celular" data-mask="(99)99999-9999" placeholder="Celular" value="${pessoaJuridica.celular}" />
                                </label>
                                <label class="breadcrumb text-center">
                                    <input readonly placeholder="E-Mail" type="email" name="email" value="${pessoaJuridica.email}" />
                                    <br>
                                </label> 
