                ...
                <div class="media">
                    <div class="media-body">
                        ...
                        <p style="text-indent: 5em; margin-left: 50px; margin-right: 50px" align="justify">
                            <span style="font-weight: bold"> ${pp.getPessoa().getNome()}</span>, ${pp.getPessoa().getNacionalidade()},
                            ${pp.getPessoa().getEstadoCivil()}, ${pp.getPessoa().getProfissao()}, RG:${pp.getPessoa().getRg()}
                            e CPF: ${pp.getPessoa().getCpf()}, residente e domiciliado à ${pp.getPessoa().getLogradouro()}, n° 
                            ${pp.getPessoa().getNro()} - ${pp.getPessoa().getBairro()} - CEP: ${pp.getPessoa().getCep()} - 
                        ...
                        <p style="text-align: center; margin-left: 50px; margin-right: 50px">${pp.getPessoa().getNome()}</p>
                    </div>
                </div>
            </div>	
