            ...
            <div class="row">
                <div class="span6">
                    <div class="page-header">
                        <h3>Consulta de Advogados</h3>
                        <form action="ControlePessoas" method="get">
                            Nome:
                            <input required type="text" name="nome">
                            <button class="btn-success ">Buscar
                                <input type="hidden" value="consultaAdvPorNome" name="op">
                            </button>
                        </form>
                        ${mensagem}
                    </div>
                ...
                <div class="span6">
                    <div class="page-header">
                        ...
                        <form action="ControlePessoas" method="get">
                            OAB:
                            <input required maxlength="6" type="text" name="oab">
                            <button class="btn-success ">Buscar
                                <input type="hidden" value="consultaAdvPorOab" name="op">
                            </button>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="media-body">
                            <c:if test="${listaAdv != null}">
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${listaAdv}" var="l">
                                        <tr>
                                            <td><a class="btn-success btn-mini" href="ControlePessoas?op=editaAdv&oab=${l.oab}">
                            ...
                            <c:if test="${AdvOab != null}">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td><a class="btn-success btn-mini" href="ControlePessoas?op=editaAdv&oab=${AdvOab.oab}">
                                                <i class="icon-edit"></i></a></td>
                                        <td>${AdvOab.oab}</td>
                                        <td>${AdvOab.nome}</td>
                                        <td>${AdvOab.email}</td> 
                                        <td>${AdvOab.telefone}</td>
                                        <td>${AdvOab.celular}</td>
                                    </tr>
                                </table>
                            </c:if>
