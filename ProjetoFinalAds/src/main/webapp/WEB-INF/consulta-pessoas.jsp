            ...
            <div class="row">
                <div class="span12">
                    <div class="page-header">
                        ...
                        <form action="ControlePessoas" method="get">
                            <select onchange="selecionaBusca()" required class="alert-success input-medium" name="op">
                                <option value="">Escolha</option>
                                <option value="ConsultaPF">Pessoa Física</option>
                                <option value="ConsultaPJ">Pessoa Jurídica</option>
                            </select>
                            Buscar por
                            <span id="pessoa"></span>
                        ...
                        <div class="media-body">
                            <c:if test="${listaPF != null}">
                                <table class="table table-hover row-fluid" >
                                    ...
                                    <c:forEach items="${listaPF}" var="l">
                                        <tr>
                                            <td><a class="btn-success btn-mini" href="ControlePessoas?op=editaPF&cpf=${l.cpf}">
                            ...
                            <c:if test="${listaPJ != null}">
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${listaPJ}" var="l">
                                        <tr>
                                            <td><a class="btn-success btn-mini" href="ControlePessoas?op=editaPJ&cnpj=${l.cnpj}">
                                                    <i class="icon-edit"></i></a></td>
                                            <td>${l.cnpj}</td>
                                            <td>${l.inscricaoEstadual}</td> 
                                            <td>${l.nomeFantasia}</td> 
                                            <td>${l.razaoSocial}</td> 
                                            <td>${l.email}</td> 
                                            <td>${l.telefone}</td>
                                            <td>${l.celular}</td>
